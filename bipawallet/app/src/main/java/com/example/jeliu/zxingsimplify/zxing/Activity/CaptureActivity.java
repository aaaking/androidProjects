package com.example.jeliu.zxingsimplify.zxing.Activity;
...
import com.example.jeliu.zxingsimplify.zxing.camera.CameraManager;
import com.example.jeliu.zxingsimplify.zxing.decode.DecodeThread;
import com.example.jeliu.zxingsimplify.zxing.utils.BeepManager;
import com.example.jeliu.zxingsimplify.zxing.utils.CaptureActivityHandler;
import com.example.jeliu.zxingsimplify.zxing.utils.InactivityTimer;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == SELECT_PIC_KITKAT && resultCode == Activity.RESULT_OK) { //4.4及以上图库
            ...
            if (result == null) {
                ...
                //Toast.makeText(context, recode, Toast.LENGTH_LONG).show();
                Intent intent = new Intent();
                intent.putExtra("barCode", recode);
                setResult(RESULT_OK, intent);
                finish();
            }
        }
